    ...
    <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
            <a class="nav-link fw-medium" href="{{ route('landing') }}#landingFeatures">Features</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-medium" href="{{ route('landing') }}#landingTeam">Team</a>
          </li>
          <li class="nav-item">
            ...
            <div class="dropdown-menu p-4 p-xl-8">
              <div class="row gy-4">
                <div class="col-12 col-lg">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item active">
                      <a class="nav-link mega-dropdown-link" href="{{ route('pricing') }}">
                ...
                <div class="col-12 col-lg">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-login-basic.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Login (Basic)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-login-cover.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Login (Cover)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-register-basic.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Register (Basic)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-register-cover.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Register (Cover)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-register-multisteps.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Register (Multi-steps)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-forgot-password-basic.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Forgot Password (Basic)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-forgot-password-cover.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Forgot Password (Cover)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-reset-password-basic.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Reset Password (Basic)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-reset-password-cover.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                ...
                <div class="col-12 col-lg">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/pages-misc-error.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Error
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/pages-misc-under-maintenance.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Under Maintenance
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/pages-misc-comingsoon.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Coming Soon
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/pages-misc-not-authorized.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Not Authorized
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-verify-email-basic.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Verify Email (Basic)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-verify-email-cover.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Verify Email (Cover)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-two-steps-basic.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Two Steps (Basic)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../admin-data-portal/auth-two-steps-cover.html" target="_blank">
                        <i class="icon-base bx bx-radio-circle me-1"></i>
                        Two Steps (Cover)
                      </a>
                    </li>
      ...
      <div class="position-relative">
        <div class="d-flex justify-content-between flex-column-reverse flex-lg-row align-items-center pt-12 pb-10">
          ...
          <div class="text-center">
            <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/img/illustrations/lady-with-laptop-light.png" class="img-fluid me-lg-5 pe-lg-1 mb-3 mb-lg-0" alt="Api Key Image" width="202" data-app-light-img="illustrations/lady-with-laptop-light.png" data-app-dark-img="illustrations/lady-with-laptop-dark.png" style="visibility: visible;">
          </div>
        </div>
      </div>
    </div>
            ...
            <table class="table table-striped text-center mb-0">
                ...
                <tr>
                  ...
                  <th scope="col">
                    <p class="mb-50 position-relative">
                      Pro
                      <span class="badge badge-center rounded-pill bg-primary position-absolute mt-n2 ms-1"><i class="icon-base bx bx-star"></i></span>
                    </p>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <span class="badge badge-center rounded-pill w-px-20 h-px-20 bg-label-secondary p-0 d-inline-flex align-items-center justify-content-center">
                  ...
                  <td>
                    <span class="badge badge-center rounded-pill w-px-20 h-px-20 bg-label-primary p-0 d-inline-flex align-items-center justify-content-center">
                      <i class="icon-base bx bx-check"></i>
                    </span>
                  </td>
                </tr>
      ...
      <div class="accordion" id="pricingFaq">
        ...
        <div class="card accordion-item">
          ...
          <div id="faq-3" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#pricingFaq">
            <div class="accordion-body">We count all responses submitted through all your forms in a month. If you already received 100 responses this month, you won’t be able to receive any more of them until next month when the counter resets.</div>
          </div>
        </div>
        <div class="card accordion-item">
